...
import type { Suite } from "../home-data";

export default function ExploreSuites({ suites }: { suites: Suite[] }) {
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="mt-3 font-display text-4xl lg:text-6xl tracking-tight">
            Six ways to live
            <br />
            <span className="italic text-muted-foreground">exceptionally well.</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            Browse our premium floor plans, designed with spacious open concepts and high-end
            finishes.
          </p>
        </div>
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                >
                  <Heart
                    className={cn(
                      "w-4 h-4",
                      saved.has(s.id) ? "fill-destructive text-destructive" : "text-foreground",
                    )}
                  />
                </button>
              </div>
