  ...
  head: () => ({
    meta: [
      ...
      { title: "Maison Rive   Luxury Rental Living in Hamilton" },
      {
        name: "description",
        content:
          "Discover Maison Rive: Beautifully designed luxury suites in Hamilton with geothermal heating, EV charging, and premium amenities. Book your private tour today.",
      },
      { name: "author", content: "Maison Rive" },
      { property: "og:title", content: "Maison Rive   Luxury Rental Living" },
      {
        property: "og:description",
        content: "Luxury suites. Premium amenities. Designed around you.",
      },
